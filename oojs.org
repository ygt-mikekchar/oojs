...
Of course JavaScript already *has* an object system, but I
...
*** A few other things are also Dictionaries (aka Objects)

There is one last issue that I want to clear up before we move on.
...
Even if you don't reasign the closed over variable, the closure can be
...
lession: mutability is a bit like a disease.  One piece of mutable
...
oriented systems, but they aren't the benefits that I actually want
from OOP.  Ideally, I'm just after better cohesion with less
unnecessary coupling in my code.  As a part of this, I value being
able to write generic code when it improves cohesion.
